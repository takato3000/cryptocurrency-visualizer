...
std_col1.metric(label="15D", value="{value:.6f}".format(value=output_df['rolling15_std'][-1]))
std_col2.metric(label="30D", value="{value:.6f}".format(value=output_df['rolling30_std'][-1]))
std_col3.metric(label="365D", value="{value:.6f}".format(value=output_df['rolling365_std'][-1]))
